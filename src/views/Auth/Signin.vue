          ...
          <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
            <div>
              <div class="mb-5 sm:mb-8 text-center">
                ...
                <p class="mb-2 font-semibold text-gray-800  dark:text-white/90 ">
                  Portal Data Rt 003 Rw 11
                </p>
                ...
                <form @submit.prevent="handleSubmit">
                  <div class="space-y-5">
                    <div>
                      ...
                      <input v-model="email" type="text" id="email" name="email" placeholder="Masukkan username anda"
          ...
          <div class="flex items-center justify-center z-1">
            ...
            <div class="flex flex-col items-center max-w-xs">
              ...
              <p class="text-center text-gray-400 dark:text-white/60">
                Selamat datang di portal data laporan Rt
              </p>
            </div>
          </div>
        </div>
...
const handleSubmit = async () => {
  ...
  try {
    ...
    // Set default header untuk axios dengan token
    axios.defaults.headers.common['Authorization'] = `Bearer ${token}`

    // Jika keep logged in dipilih, bisa tambahkan logic tambahan
    ...
    if (error.response?.status === 401) {
      ...
      errorMessage = error.response.data?.message || 'Data login tidak valid'
    } else if (error.response?.data?.message) {
      errorMessage = error.response.data.message
    } else if (error.message === 'Network Error') {
      errorMessage = 'Gagal terhubung ke server. Pastikan server sudah berjalan.'
    }
